...
def apply_unified_to_model(
    ...
    deltas = execute_unified(alg_name, model, tok, requests, hparams, cache_template=cache_template)
...
def execute_unified(
    ...
    """
    Executes the update algorithm for ROME, MEMIT and EMMET for the specified update at the specified layer
