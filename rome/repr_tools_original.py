...
def get_words_idxs_in_templates(
    ...
    template, computes the 'post-tokenization index' of their last tokens, or requested tokens of the subject.
    """
    ...
    # Pre-process tokens. Remove space from prefixes. Add space in from of the subject that needs to be replaced.
...
def get_reprs_at_idxs(
    ...
    for batch_contexts, batch_idxs in _batch(n=64):
